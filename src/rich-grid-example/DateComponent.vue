...
<div class="filter">
  ...
  <input class="dd" @change="onDateChanged('dd', $event)" placeholder="dd" v-model="dd" maxLength="2" />/
  <input class="mm" @change="onDateChanged('mm', $event)" placeholder="mm" v-model="mm" maxLength="2" />/
  <input class="yyyy" @change="onDateChanged('yyyy', $event)" placeholder="yyyy" v-model="yyyy" maxLength="4" />
</div>
</template>
